object Q3andQ4{
	...
	def main(args: Array[String]): Unit = {
		...
		val a1 = new Account("960989786V", 1000001, 134.5);
		val a2 = new Account("934567891V", 1000002, 432.75);
		...
		//This list will be used to do the operations
		var bank:List[Account] = List(
			a1,a2,new Account("960453581V", 1000003, -302.75),
